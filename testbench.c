...
//        base_gauge_render_to(BASE_GAUGE(gauge), elapsed, screenSurface, &dst);
//        base_gauge_render_to(BASE_GAUGE(wheel), elapsed, screenSurface, &wheelrect);
//        base_gauge_render_to(BASE_GAUGE(ladder), elapsed, screenSurface, &lrect);

//        base_gauge_render_to(BASE_GAUGE(alt_ind), elapsed, screenSurface, &airect);
//        base_gauge_render_to(BASE_GAUGE(stair), elapsed, screenSurface, &vrect);
...
//        alt_group_render_to(group, elapsed, screenSurface, &airect);
//        SDL_BlitSurface(airspeed_indicator_render(asi, elapsed), NULL, screenSurface, &vrect);
         base_gauge_render_to(BASE_GAUGE(asi), elapsed, screenSurface, &vrect);


//          base_gauge_render_to(BASE_GAUGE(rsg), elapsed, screenSurface, &dst);
...
//        attitude_indicator_render_to(ai, elapsed, screenSurface, &attrect);
